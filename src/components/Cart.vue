<template>
  <div class="cart">
    ...
    <main class="cart-body" v-if="cartGoods.length > 0">
      <div class="wrap">
        <ul class="goods-wrap">
          <li v-for="(item, i) in cartGoods" cartGoodsItem>
            <cart-one-item
              :itemId="item.id"
              :imgUrl="item.img"
              :title="item.title"
        ...
        <div class="price-wrap">
          ...
          <div class="red-packet">
            <div>
              ...
              <el-select
                v-model="redPacket"
                :placeholder="redPacketPlaceholder"
              >
                <el-option
              ...
              <span class="float-right" v-show="redPacket"
                >-￥{{ redPacket }}</span
              >
            </div>
          </div>
          <div class="pay">
            ...
            <div>
              ...
              <span class="float-right">
                <span class="postage" v-show="needPostage"
                  >￥{{ postage }}</span
                >
    ...
    <footer class="cart-footer" v-show="cartGoods.length > 0">
      <div class="toPay">
        <el-button type="danger" class="text-right" @click="toOrderForm"
          >去结算<i class="el-icon-arrow-right el-icon--right"></i
        ></el-button>
      </div>
    </footer>
